<?php 
    ...
    $paper1->setAuthors($paper1Authors); //authors and bibtext not working!
    $test = $paper1->getAuthors();
    $paper1->setConference("Conference_1");
    $paper1->setAbstract("Abstract_1");
    $paper1->setLink("placeholder");
    $paper1->setBibtex("placeholder");
    ...
    $paper2Authors = array("Martin Luther King Jr.", "Kruschev");
    $paper2->setAuthors($paper2Authors);
    $paper2->setConference("Conference_1");
    $paper2->setAbstract("Abstract_2");
    $paper2->setLink("placeholder");
    $paper2->setBibtex("placeholder");
    ...
    $paper3Authors = array("Hannibal Lecter", "Lord Farquad", "Donald Trump");
    $paper3->setAuthors($paper3Authors);
    $paper3->setConference("Conference_2");
    $paper3->setAbstract("Abstract_3");
    $paper3->setLink("placeholder");
    $paper3->setBibtex("placeholder");
    ...
    $paper4Authors = array("Adolf Hitler", "Brad Pitt", "Weird Al Yanokovic");
    $paper4->setAuthors($paper4Authors);
    $paper4->setConference("Conference_1");
    $paper4->setAbstract("Abstract_4");
    $paper4->setLink("placeholder");
    $paper4->setBibtex("placeholder");
    ...
    $paper5Authors = array("Arman Akhbari", "Brian Bares", "Shokoufeh Namazian", "Matt van Niekierk");
    $paper5->setAuthors($paper5Authors);
    $paper5->setConference("Conference_2");
    $paper5->setAbstract("Abstract_5");
    $paper5->setBibtex("placeholder");
    $paper5->setLink("placeholder");
